...
- The winning-versus-failed offer analysis reports the average, minimum, maximum, and P10/P25/P50/P75/P90 provider offer for each outcome. It also compares failed-offer percentile bands against all outcomes in the same dollar range and lists the 20 highest failed offers with their available case context.
